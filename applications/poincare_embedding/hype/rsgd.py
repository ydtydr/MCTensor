...
from MCTensor.MCOptim import MCOptimizer  # noqa


class MCRiemannianSGD(MCOptimizer):
    r"""MCRiemannian stochastic gradient descent.
    ...
    def __init__(
        ...
        super(MCRiemannianSGD, self).__init__(params, defaults)

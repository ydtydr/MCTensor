...
print(f"CELoss_the train loss for d16: {LOSS16[-1]}, test acc for d16 {acc_test16[-1]}")
print(f"CELoss_the train loss for d32: {LOSS32[-1]}, test acc for d32 {acc_test32[-1]}")
print(f"CELoss_the train loss for d64: {LOSS64[-1]}, test acc for d64 {acc_test64[-1]}")
